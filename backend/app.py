...
def get_children_nodes(parent_id, complementary = True):
    ...
    def get_similar_products(product_id, k=100):
    ...
    similar_products = get_similar_products(parent_id, k=100)
    product_descriptions_df = pd.read_parquet("../data/sample_item_info.parquet")
    ...
    return get_complementary_products_blair(parent_id, similar_products, complementary, 3)
